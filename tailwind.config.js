...
module.exports = {
  ...
  important: true, // This ensures Tailwind's classes override Angular Material's styles
  theme: {
    extend: {
      colors: {
        // Extend with our custom colors from the Angular Material theme
        primary: {
          50: '#e3f2fd',
          100: '#bbdefb',
          200: '#90caf9',
        ...
        // Google-inspired neutral colors
        neutral: {
          50: '#fafafa',
          100: '#f5f5f5',
          200: '#eeeeee',
  ...
  plugins: [],
  // Disable some Tailwind features that might conflict with Angular Material
  corePlugins: {
